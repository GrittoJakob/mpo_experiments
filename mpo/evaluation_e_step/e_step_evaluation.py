...
from .helpers.plot_dist import plot_mpo_weight_distribution
...
def expectation_step_eval(mpo, target_q,mu_off, std_off, sampled_actions, writer=None, step=None):
    ...
    norm_target_q, loss_temperature = compute_weights_temperature_loss(
    ...
    log_figure(writer, fig, "e-step/original_weights", step)
    ...
    log_figure(writer, fig, "e-step/action_penalty_weights", step)
    ...
    log_figure(writer, fig, "e-step/final_distribution", step)
