...
def train_loop(
    ...
    while num_steps < max_training_steps:
        ...
        for i_update in range(num_updates_per_iter):
            ...
            critic_update_stats, sampled_actions, b_mu, b_A = mpo.critic_update_td( state_batch, action_batch, next_state_batch, reward_batch, args.sample_action_num)
            ...
            if i_update % args.delay_policy_update == 0:
                ...
                stats_m = mpo.maximization_step(state_batch,norm_target_q, sampled_actions, b_mu, b_A)
